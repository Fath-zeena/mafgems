...
// The new, stable Pendant component, centered at [0,0,0]
function Pendant() {
  ...
  return (
    <group>
      {/* Pendant Setting - This is now the center of the scene */}
      ...
      {/* Chain Loops, positioned relative to the centered pendant */}
